    ...
    <div className="min-h-screen bg-muted">
      <div className="container mx-auto px-6 py-10 max-w-6xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <StatCard label="Past Cyclones"  value={stats?.total ?? '—'}                               icon={<Wind size={18} className="text-gray-500" />}         color="bg-gray-50" />
          ...
          <StatCard label="Active" value={stats?.activeCycloneName ? `${stats.activeCycloneName}` : '—'}                              icon={<BarChart2 size={18} className="text-gray-500" />}    color="bg-gray-50" />
        </div>
